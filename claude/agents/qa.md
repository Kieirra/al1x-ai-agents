...
**Fallback obligatoire en mode sub-agent** : si le Agent tool n'est pas disponible, exécute toi-même, dans l'ordre, toutes les tâches pertinentes de l'étape 2. Produis le même rapport final et indique que les analyses ont été réalisées sans délégation.
...
### Étape 2 : Dispatch parallèle via Agent tool, ou exécution séquentielle en fallback
