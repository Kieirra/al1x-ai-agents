...
1. **Si la demande contient un chemin** : utiliser ce fichier directement
...
Après capture, **inspecter chaque screenshot** avec l'outil d'inspection d'images disponible et vérifier :
