...
Ce fichier contient les frameworks UX/UI à appliquer lors de la spécification d'interfaces. Il est lu par Scala (scrum-master) pour enrichir les sections UX/UI des User Stories.
